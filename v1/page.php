...
$name_groom = "Colin";
$name_bride = "Chloe";
$carousel1_img = "cc-bkgnd.jpg";
$carousel2_img = "cc-bkgnd2.jpg";
...
<head>
    <meta charset="utf-8">
    <title><?php echo "$name_groom & $name_bride" ?> - We're getting married!</title>
...
<body data-spy="scroll" data-target=".navbar" data-offset="51">
    ...
    <div class="container-fluid p-0 mb-5 pb-5" id="home">
		...
		<img class="position-absolute w-100 h-100" src="img/<?php echo "$carousel1_img" ?>" style="object-fit: cover;">
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h1 class="display-1 font-secondary text-white mt-n3 mb-md-4"><?php echo "$name_groom & $name_bride" ?></h1>
		...
		<img class="position-absolute w-100 h-100" src="img/<?php echo "$carousel2_img" ?>" style="object-fit: cover;">
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h1 class="display-1 font-secondary text-white mt-n3 mb-md-4"><?php echo "$name_groom & $name_bride" ?></h1>
                            <div class="d-inline-block border-top border-bottom border-light py-3 px-4">
